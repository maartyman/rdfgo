...
func ParseFile(fileName string, options ParserOptions) (interfaces.IStream, chan error) {
...
func Parse(stream io.Reader, options ParserOptions) (interfaces.IStream, chan error) {
	if options.Format == "" {
